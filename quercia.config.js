...
module.exports = function({ config, target, mode }) {
  if (target === 'client') {
    ...
    config.optimization.splitChunks.cacheGroups.vendor.test = /(?<!node_modules.*)[\\/]node_modules[\\/](react|react-dom|scheduler|prop-types|object-assign|preact|@quercia\/(quercia|cli)|core-js|babel-plugin-transform-async-to-promises|react-hot-loader|@hot-loader|html-entities|@styled-system|styled-system|@emotion\/*|reflexbox|rebass|deep-extend)[\\/]/
